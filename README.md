...
2) PHP - all the forms used are done with prepared statements (PDO). Created sign up, log in and log out working forms. User can log in using forms to view 'forum threads' and to make a new threads (rudimentary at the moment).
